# Formación RHCE in Ansible Practice Courses
...
[Explorar cursos en LabEx](https://labex.io/es/learn/rhce-ansible)

|   Índice | Curso                                                                                                 | Dificultad   | Repositorio                                                         | Práctica                                                                 |
|----------|-------------------------------------------------------------------------------------------------------|--------------|---------------------------------------------------------------------|--------------------------------------------------------------------------|
|        1 | [Preparación para RHCE Ansible (EX294)](https://labex.io/es/courses/rhce-ansible-prep)                | Principiante | [Repo](https://github.com/labex-labs/rhce-ansible-prep)             | [Iniciar lab](https://labex.io/es/courses/rhce-ansible-prep)             |
|        2 | [Examen de práctica 01 de RHCE en Ansible](https://labex.io/es/courses/rhce-ansible-practice-exam-01) | Intermedio   | [Repo](https://github.com/labex-labs/rhce-ansible-practice-exam-01) | [Iniciar lab](https://labex.io/es/courses/rhce-ansible-practice-exam-01) |
|        3 | [Examen de práctica 02 de RHCE en Ansible](https://labex.io/es/courses/rhce-ansible-practice-exam-02) | Intermedio   | [Repo](https://github.com/labex-labs/rhce-ansible-practice-exam-02) | [Iniciar lab](https://labex.io/es/courses/rhce-ansible-practice-exam-02) |
