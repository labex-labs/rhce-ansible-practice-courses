# RHCE in Ansible 교육 Practice Courses
...
[LabEx에서 코스 보기](https://labex.io/ko/learn/rhce-ansible)

|   인덱스 | 코스                                                                                      | 난이도   | 저장소                                                                 | 연습                                                                 |
|-------|-----------------------------------------------------------------------------------------|-------|---------------------------------------------------------------------|--------------------------------------------------------------------|
|     1 | [RHCE Ansible 준비 과정 (EX294)](https://labex.io/ko/courses/rhce-ansible-prep)             | 초급    | [Repo](https://github.com/labex-labs/rhce-ansible-prep)             | [실습 시작](https://labex.io/ko/courses/rhce-ansible-prep)             |
|     2 | [RHCE in Ansible 실전 모의고사 01](https://labex.io/ko/courses/rhce-ansible-practice-exam-01) | 중급    | [Repo](https://github.com/labex-labs/rhce-ansible-practice-exam-01) | [실습 시작](https://labex.io/ko/courses/rhce-ansible-practice-exam-01) |
|     3 | [RHCE in Ansible 실전 모의고사 02](https://labex.io/ko/courses/rhce-ansible-practice-exam-02) | 중급    | [Repo](https://github.com/labex-labs/rhce-ansible-practice-exam-02) | [실습 시작](https://labex.io/ko/courses/rhce-ansible-practice-exam-02) |
